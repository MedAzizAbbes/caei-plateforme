                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-1 md:col-span-2 mt-4 p-5 md:p-6 bg-slate-50 border-l-4 border-[#061743] rounded-r-xl shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="location-input" name="location" value="{{ old('location') }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743] shadow-sm" placeholder="Sélectionnez ou tapez un lieu...">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="country-badge" name="country_badge" value="{{ old('country_badge') }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743] shadow-sm" placeholder="Sélectionnez ou tapez un pays...">
                            </div>
                    ...
                    <div class="col-span-1 md:col-span-2 mt-6">
                        <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-bold text-slate-700 mb-2">Image de couverture <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="main_image_alt" value="{{ old('main_image_alt') }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743]" placeholder="Description de l'image (SEO)">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 mt-2">
                        <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" name="gallery_title" value="{{ old('gallery_title') }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743]" placeholder="Ex: Retour en images sur le séminaire">
                            </div>
    ...
    function addGalleryItem() {
        ...
        item.innerHTML = `
            <div class="flex justify-between items-center mb-3">
                <span class="font-bold text-sm text-[#061743]">Photo de la galerie</span>
