            ...
            <form action="{{ route('admin.actualites.update', $actualite->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-1 md:col-span-2 mt-4 p-5 md:p-6 bg-slate-50 border-l-4 border-[#061743] rounded-r-xl shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="location" value="{{ old('location', $actualite->location) }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743] shadow-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="country_badge" value="{{ old('country_badge', $actualite->country_badge) }}" class="w-full rounded-lg border-slate-300 focus:border-[#061743] focus:ring-[#061743] shadow-sm">
                            </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-2">Image Principale (laisser vide pour ne pas modifier)</label>
                                @if($actualite->main_image)
                                    <div class="mb-2">
                                        <img src="{{ asset($actualite->main_image) }}" class="h-20 w-auto rounded border">
                                    </div>
                                @endif
                            ...
                            <div>
                                ...
                                <input type="text" name="main_image_alt" value="{{ old('main_image_alt', $actualite->main_image_alt) }}" class="w-full rounded-lg border-slate-200">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="gallery_title" value="{{ old('gallery_title', $actualite->gallery_title) }}" class="w-full rounded-lg border-slate-200">
                        </div>
                                ...
                                @foreach($actualite->gallery as $i => $photo)
                                    <div class="p-4 border border-slate-200 rounded-lg bg-white relative">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                                            <div>
                                                <label class="block text-xs font-bold text-slate-700 mb-1">Image existante</label>
                                                <input type="hidden" name="existing_gallery_images[{{ $i }}]" value="{{ $photo['image'] }}">
                                                <img src="{{ asset($photo['image']) }}" class="mt-2 h-20 w-auto object-cover rounded border border-slate-200">
                                            </div>
                                            <div>
                                                <label class="block text-xs font-bold text-slate-700 mb-1">Titre de la photo</label>
                                                <input type="text" name="existing_gallery_titles[{{ $i }}]" value="{{ $photo['title'] ?? '' }}" class="w-full rounded-lg border-slate-200 text-sm">
                                            </div>
                                            <div>
                                                <label class="block text-xs font-bold text-slate-700 mb-1">Description</label>
                                                <input type="text" name="existing_gallery_descs[{{ $i }}]" value="{{ $photo['desc'] ?? '' }}" class="w-full rounded-lg border-slate-200 text-sm">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
...
<script>
    ...
    function addGalleryItem() {
        ...
        item.innerHTML = `
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">Nouvelle image *</label>
