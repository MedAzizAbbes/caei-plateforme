...
@section('content')
<div class="flex min-h-screen -mt-8 -mx-4 sm:-mx-6 lg:-mx-8" style="background: linear-gradient(135deg, rgba(241, 245, 249, 0.85) 0%, rgba(226, 232, 240, 0.88) 100%), url('{{ asset('assets/img/service_training_1786525661524.jpg') }}') center/cover fixed no-repeat;">
    ...
    <div class="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        {{-- En-tête du module --}}
        <div class="mb-8 rounded-2xl p-8 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden" style="background: linear-gradient(135deg, rgba(6, 23, 67, 0.88) 0%, rgba(0, 15, 60, 0.92) 100%), url('{{ asset('assets/img/service_training_1786525661524.jpg') }}') center/cover no-repeat;">
            ...
            <div class="relative z-10">
                ...
                <p class="mt-2 text-slate-200 text-sm">Consultez, gérez et suivez les demandes d'inscription et de rendez-vous soumis via le portail Elite Training.</p>
            </div>
            <div class="shrink-0 flex items-center gap-3 relative z-10">
                <a href="{{ route('admin.formations.index') }}" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold text-xs px-4 py-2.5 rounded-xl border border-white/20 transition-all">
                    <span>📚 Catalogue Formations</span>
                </a>
                <a href="{{ route('elite.training') }}" target="_blank" class="inline-flex items-center gap-2 bg-[#f2a90f] hover:bg-amber-400 font-bold text-xs px-4 py-2.5 rounded-xl shadow transition-all" style="color: #061743;">
