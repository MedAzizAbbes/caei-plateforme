...
<head>
  ...
  <title>Politique de Confidentialité - Digital-MOOV</title>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 12px; background: #fff;">
          <h3 class="mb-4" style="color: var(--color-primary); font-weight: 700;">Protection de vos données personnelles</h3>
          <p class="text-muted leading-relaxed">
            Chez CAEI Digital Moov, la confidentialité et la sécurité de vos données personnelles sont au cœur de nos préoccupations. Cette politique décrit la manière dont nous collectons, utilisons et protégeons vos informations lorsque vous utilisez notre portail numérique.
          </p>

          <h5 class="mt-4 fw-bold text-dark">1. Collecte des informations</h5>
          <p class="text-muted">
            Nous collectons des informations lorsque vous remplissez nos formulaires de contact ou de devis en ligne (nom, adresse email, numéro de téléphone, et détails du projet). Ces informations sont nécessaires pour traiter vos demandes d'accompagnement numérique.
          </p>

          <h5 class="mt-4 fw-bold text-dark">2. Utilisation des données</h5>
          <p class="text-muted">
            Toutes les informations que nous recueillons auprès de vous sont exclusivement utilisées pour :
          </p>
          <ul class="text-muted ps-4 mb-4">
            <li class="mb-2">Personnaliser votre expérience et répondre à vos besoins individuels.</li>
            <li class="mb-2">Fournir un contenu de service d'assistance client réactif.</li>
            <li class="mb-2">Vous contacter par e-mail ou par téléphone dans le cadre du traitement de votre demande de devis.</li>
          </ul>

          <h5 class="mt-4 fw-bold text-dark">3. Confidentialité et Tiers</h5>
          <p class="text-muted">
            Nous sommes les uniques propriétaires des informations recueillies sur ce site. Vos informations personnelles ne seront pas vendues, échangées, transférées, ou données à une autre société à des fins commerciales sans votre consentement explicite.
          </p>

          <h5 class="mt-4 fw-bold text-dark">4. Sécurité des informations</h5>
          <p class="text-muted mb-0">
            Nous mettons en œuvre une variété de mesures de sécurité pour préserver la sécurité de vos informations personnelles. Nous utilisons un chiffrement à la pointe de la technologie pour protéger les informations sensibles transmises en ligne. Nos bases de données locales respectent les normes et règlements de protection des données (RGPD).
          </p>
        </div>
      </div>
    </section>
