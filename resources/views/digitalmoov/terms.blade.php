...
<head>
  ...
  <title>Mentions Légales & Conditions - Digital-MOOV</title>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('{{ asset('digitalmoov/assets/img/people-working-as-team-company.jpg') }}');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        <h2>Mentions Légales & Conditions</h2>
        <ol>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 12px; background: #fff;">
          <h3 class="mb-4" style="color: var(--color-primary); font-weight: 700;">Mentions Légales</h3>
          
          <h5 class="fw-bold text-dark">1. Éditeur de la plateforme</h5>
          <p class="text-muted">
            Le site <strong>CAEI Digital Moov</strong> est édité par le groupe CAEI COMPANY GROUP.<br>
            <strong>Adresse du siège social :</strong> Immeuble Medina Palace au 53-55, Avenue de Paris Tunis-Tunisie, 1001.<br>
            <strong>Téléphone :</strong> +216 55 335 286<br>
            <strong>E-mail :</strong> contact@caei-afri.com
          </p>

          <h5 class="mt-4 fw-bold text-dark">2. Hébergement de la plateforme</h5>
          <p class="text-muted">
            La plateforme est hébergée sur des serveurs sécurisés locaux et en ligne dans le cadre des solutions de déploiement et de cloud gérées par l'infrastructure technologique de CAEI.
          </p>

          <h5 class="mt-4 fw-bold text-dark">3. Propriété Intellectuelle</h5>
          <p class="text-muted mb-4">
            L'ensemble des contenus figurant sur ce portail (logos, textes, charte graphique, images et vidéos) est protégé par les lois internationales sur le droit d'auteur et la propriété intellectuelle. Toute reproduction, distribution ou modification sans autorisation expresse écrite de l'éditeur est strictement interdite.
          </p>

          <hr class="my-5">

          <h3 class="mb-4" style="color: var(--color-primary); font-weight: 700;">Conditions Générales d'Utilisation (CGU)</h3>

          <h5 class="fw-bold text-dark">1. Objet</h5>
          <p class="text-muted">
            Les présentes CGU ont pour objet de définir les modalités de mise à disposition des services du portail CAEI Digital Moov et les conditions d'utilisation par les utilisateurs.
          </p>

          <h5 class="mt-4 fw-bold text-dark">2. Accès et Services</h5>
          <p class="text-muted mb-0">
            L'accès aux fiches de présentation, expertises, projets et catalogue PDF est public. L'accès aux formulaires de contact et demandes de devis implique la fourniture de données véridiques. CAEI se réserve le droit de restreindre ou modifier l'accès à ses services à tout moment pour des raisons de maintenance.
          </p>
        </div>
      </div>
    </section>
