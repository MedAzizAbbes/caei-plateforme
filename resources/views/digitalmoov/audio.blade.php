...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('{{ asset('digitalmoov/assets/img/audio-visual-services.webp') }}');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2>Audio-Visual Service </h2>
...
<a href="{{ route('digitalmoov.connexion') }}" class="button">Réserver</a>
          ...
          <div class="col-lg-8">
            <h3>Digital Moov : Élevez votre présence en ligne avec notre service audiovisuel, offrant une expérience immersive à votre audience.</h3>
            <p>
                Le service audiovisuel de Digital Moov est une solution complète conçue pour aider les entreprises à créer et à diffuser du contenu audiovisuel de haute qualité pour renforcer leur présence en ligne et engager leur audience de manière efficace. Cette offre comprend une gamme variée de services et de compétences pour répondre aux besoins spécifiques de chaque client.            </p>
            

            <p>
                Nos services audiovisuels comprennent la production de vidéos professionnelles, telles que des vidéos promotionnelles, des tutoriels, des interviews, des présentations de produits, des vidéos explicatives et bien plus encore. Notre équipe expérimentée de vidéastes, de réalisateurs et de monteurs travaille en étroite collaboration avec nos clients pour donner vie à leur vision et créer un contenu captivant et convaincant.  </p>
