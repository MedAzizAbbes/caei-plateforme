...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('{{ asset('digitalmoov/assets/img/img.png') }}');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2>Qu’est-ce qu’une campagne emailing ?!</h2>
        <ol>
          <li><a href="{{ route('digitalmoov') }}">Agence</a></li>
          <li>Expertises</li>
        </ol>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Campagnes d'E-mailing avec Digital Moov : Engagez, Convertissez, Fidélisez</h2>
              <p>
                L’emailing est une action de marketing direct qui consiste à envoyer du courrier électronique à plusieurs destinataires d’une base de données. Cet envoi est groupé, réalisé en même temps et de manière ciblée. En règle générale, cette pratique désigne l’envoi de campagnes d’email marketing simples, mais on peut également parler de Marketing Automation. Elle permet la programmation d’envoi de messages électroniques en fonction du profil des destinataires d’une campagne emailing.              </p>
              <p>
                Les campagnes d'e-mailing sont un levier puissant du marketing digital, permettant d'engager votre audience, de générer des leads qualifiés et de fidéliser vos clients existants. Chez Digital Moov, nous mettons en place des campagnes d'e-mailing stratégiques et efficaces pour maximiser votre retour sur investissement et atteindre vos objectifs marketing.
