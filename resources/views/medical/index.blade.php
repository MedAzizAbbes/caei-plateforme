...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-white text-slate-800 min-h-screen selection:bg-[#0d9488] selection:text-white">

        {{-- ══════════ TOPBAR MEDICAL (CLAIRE & ÉPURÉE) ══════════ --}}
        <div class="bg-[#0f172a] text-slate-200 text-xs py-2.5 px-4 border-b border-slate-800">
            <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-3">
                ...
                <div class="flex items-center gap-4 ms-auto">
                    <a href="{{ route('home') }}" class="text-xs text-slate-300 hover:text-teal-300 font-medium transition-colors">← Groupe CAEI</a>
                    <a href="https://caei-afri.com/Medicalservices/PDF/catalogueCAEIMedicalServices.pdf" target="_blank" class="inline-flex items-center gap-1.5 text-[11px] font-bold text-white bg-[#0d9488] hover:bg-[#0f766e] px-3.5 py-1 rounded-full shadow-sm transition-all">
                        📄 Catalogue PDF
                    </a>
                </div>
            </div>
        ...
        <nav class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm px-4 lg:px-8 py-3.5">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <a href="{{ route('medical.services') }}" class="flex items-center gap-3.5 hover:scale-105 transition-transform">
                    <div class="relative">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo CAEI Medical Services" class="h-12 w-12 md:h-14 md:w-14 rounded-full object-cover shadow-md border-2 border-[#0d9488]">
                        <span class="absolute -bottom-1 -right-1 bg-[#0d9488] text-white p-0.5 rounded-full border-2 border-white">
                    ...
                    <div>
                        ...
                        <span class="block text-[10px] font-bold text-[#0d9488] uppercase tracking-widest mt-1">Services & Évacuation Sanitaire</span>
                    </div>
                </a>
                ...
                <div class="hidden lg:flex items-center gap-8 text-sm font-semibold">
                    ...
                    <a href="#contact" class="text-slate-600 hover:text-[#0d9488] transition-colors">Contact</a>
                </div>

                {{-- Action Button --}}
                <div class="flex items-center gap-3">
                    <a href="#devis" class="inline-flex items-center justify-center gap-2 bg-[#0d9488] hover:bg-[#0f766e] text-white font-bold text-xs md:text-sm px-5 py-2.5 rounded-xl shadow-md shadow-teal-500/20 hover:scale-105 transition-all">
        ...
        {{-- ══════════ HERO SECTION AVEC BACKGROUND PHOTO SUBTILE ══════════ --}}
        <section id="accueil" class="relative py-16 lg:py-24 px-4 overflow-hidden bg-hero-pattern border-b border-teal-50">
            <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                
                {{-- Text column --}}
                <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 bg-white/90 border border-teal-200 shadow-sm px-4 py-1.5 rounded-full text-[#0d9488] font-extrabold text-xs uppercase tracking-wider backdrop-blur-md">
                        <span class="w-2.5 h-2.5 rounded-full bg-[#0d9488] animate-ping"></span>
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 uppercase tracking-tight leading-tight">
                        CAEI <span class="medical-teal-text">MEDICAL SERVICES</span>
                    </h1>

                    <p class="text-lg sm:text-xl text-slate-700 font-medium leading-relaxed max-w-2xl bg-white/60 backdrop-blur-xs p-2 rounded-xl border border-white/50">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                        <a href="#devis" class="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#0d9488] hover:bg-[#0f766e] text-white font-black text-base px-8 py-4 rounded-2xl shadow-lg shadow-teal-600/25 hover:scale-105 transition-all">
                            <span>Demander un Devis Gratuit</span>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        </a>
                        <a href="#evacsan" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-rose-500 hover:bg-rose-50 text-rose-700 font-bold text-base px-6 py-4 rounded-2xl bg-white shadow-sm transition-all">
                    ...
                    <div class="pt-8 border-t border-slate-200/80 grid grid-cols-3 gap-4 text-center lg:text-left">
                        <div class="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-teal-100 shadow-sm">
                            <div class="text-2xl lg:text-3xl font-black text-[#0d9488]">100%</div>
                ...
                <div class="lg:col-span-5">
                    <div class="bg-white/95 backdrop-blur-md p-8 rounded-3xl border border-teal-200 shadow-xl space-y-6">
                        <div class="flex items-center justify-between border-b border-slate-100 pb-4">
                            <div class="flex items-center gap-3">
                                <div class="w-11 h-11 rounded-full bg-teal-50 text-[#0d9488] flex items-center justify-center font-bold text-xl border border-teal-100 shadow-sm">
                                    ⚕️
                                </div>
                                <div>
                                    <div class="text-base font-black text-slate-900 uppercase">Séjour Santé Tout Compris</div>
                                    <div class="text-xs text-[#0d9488] font-bold">Accompagnement Sur-Mesure</div>
                                </div>
                            </div>
                            <span class="bg-teal-100 text-[#0d9488] text-[10px] font-black px-2.5 py-1 rounded-full uppercase">ISO Certified</span>
                        </div>

                        <ul class="space-y-4 text-sm text-slate-700">
                            <li class="flex items-start gap-3">
                                <span class="w-5 h-5 rounded-full bg-teal-100 text-[#0d9488] flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">✓</span>
                        ...
                        <div class="bg-teal-50 p-4 rounded-2xl border border-teal-200/60 text-xs text-slate-700 flex items-center justify-between shadow-xs">
                            <span class="font-semibold">📞 Support Direct Patient :</span>
                            <span class="font-black text-[#0d9488] text-sm">+216 53 359 515</span>
                        </div>
                    </div>
                </div>
        ...
        @if(session('success'))
            <div class="max-w-4xl mx-auto my-6 px-4">
                <div class="bg-emerald-50 border border-emerald-300 text-emerald-900 p-5 rounded-2xl flex items-center gap-4 shadow-sm">
        ...
        <section id="about" class="py-20 bg-about-pattern text-slate-800 border-b border-slate-200/60">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <div class="w-20 h-1 bg-[#0d9488] mx-auto mt-4 rounded-full"></div>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6 text-slate-700 leading-relaxed text-base bg-white/80 backdrop-blur-md p-6 rounded-3xl border border-slate-200/80 shadow-sm">
                        <p class="text-lg font-semibold text-slate-900">
                            La Tunisie s'impose aujourd'hui comme <span class="text-[#0d9488] font-bold">l'une des meilleures destinations mondiales de tourisme médical</span>, combinant des normes chirurgicales européennes et des coûts maîtrisés.
                        </p>
                        <p>
        ...
        <section id="services" class="py-24 bg-white relative">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <p class="text-xs font-black uppercase text-[#0d9488] tracking-widest">Prestations Certifiées</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($services as $service)
                        <div class="relative overflow-hidden rounded-3xl border border-slate-200/90 shadow-md card-hover-light flex flex-col justify-between bg-white group"
                            ...
                            <div class="h-36 w-full relative overflow-hidden">
                                ...
                                <div class="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
                                    <span class="bg-white/90 backdrop-blur-md text-[#0d9488] border border-teal-200 text-xs font-black px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                                        {{ $service['badge'] }}
                                    </span>
                                    <div class="w-10 h-10 rounded-full bg-white/90 backdrop-blur-md text-[#0d9488] flex items-center justify-center font-bold text-lg border border-teal-200 shadow-sm">
                                        ⚕️
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-8 pt-2 flex flex-col justify-between flex-grow">
                                <div>
                                    ...
                                    <p class="text-slate-600 text-xs leading-relaxed mb-6 font-medium bg-white/80 backdrop-blur-xs p-2 rounded-xl border border-slate-100">
                                        {{ $service['description'] }}
                                    </p>
                                    ...
                                    <ul class="space-y-2.5 mb-6">
                                        @foreach($service['features'] as $feature)
                                            <li class="flex items-center gap-2.5 text-xs text-slate-800 font-semibold">
                                                <svg class="w-4 h-4 text-[#0d9488] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                                                <span>{{ $feature }}</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                ...
                                <a href="#devis" class="inline-flex items-center justify-center gap-2 w-full py-3 bg-[#f0fdfa] hover:bg-[#0d9488] text-[#0d9488] hover:text-white border border-teal-200 font-bold text-xs rounded-xl transition-all shadow-sm">
        ...
        <section id="evacsan" class="py-20 bg-evacsan-pattern text-white relative shadow-xl">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-black/20 backdrop-blur-md rounded-3xl p-8 lg:p-12 border border-white/30 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="lg:col-span-4 text-center lg:text-right space-y-4">
                        <a href="tel:+21653359515" class="inline-flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-rose-700 font-black text-lg px-8 py-4 rounded-2xl shadow-xl hover:scale-105 transition-all w-full sm:w-auto">
        ...
        <section id="devis" class="py-24 bg-devis-pattern relative border-b border-slate-200">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white/95 backdrop-blur-md p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-xl">
                    <div class="text-center mb-10">
                        <span class="bg-teal-50 text-[#0d9488] border border-teal-200 text-xs font-black px-3.5 py-1 rounded-full uppercase tracking-wider">Demande Confidentielle & Gratuite</span>
                    ...
                    <form action="{{ route('medical.services.request') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="fullname" required placeholder="Ex: Jean Dupont" class="w-full bg-[#f8fafc] border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm focus:border-[#0d9488] focus:bg-white focus:outline-none transition-all">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Adresse Email *</label>
                                <input type="email" name="email" required placeholder="Ex: jean.dupont@email.com" class="w-full bg-[#f8fafc] border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm focus:border-[#0d9488] focus:bg-white focus:outline-none transition-all">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="phone" required placeholder="Ex: +225 07 00 00 00" class="w-full bg-[#f8fafc] border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm focus:border-[#0d9488] focus:bg-white focus:outline-none transition-all">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Pays de Résidence *</label>
                                <input type="text" name="country" required placeholder="Ex: Côte d'Ivoire, Sénégal, France..." class="w-full bg-[#f8fafc] border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm focus:border-[#0d9488] focus:bg-white focus:outline-none transition-all">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="4" placeholder="Décrivez succinctement vos besoins ou symptômes..." class="w-full bg-[#f8fafc] border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm focus:border-[#0d9488] focus:bg-white focus:outline-none transition-all"></textarea>
                        </div>

                        <button type="submit" class="w-full bg-[#0d9488] hover:bg-[#0f766e] text-white font-black text-base py-4 rounded-xl shadow-lg shadow-teal-600/20 hover:scale-[1.01] transition-all">
        ...
        <footer id="contact" class="bg-[#0f172a] text-slate-300 py-16 text-sm">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
