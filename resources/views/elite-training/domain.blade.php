  ...
  <footer class="et-footer" style="background: #00142b; padding: 45px 0 25px; text-align: center; border-top: 1px solid rgba(255,255,255,0.08);">
    <div class="container">
      ...
      <p class="mb-0" style="color: rgba(255,255,255,0.5); font-size: 13px;">
        © {{ date('Y') }} <a href="{{ route('elite.training') }}" style="color: #ce9233; text-decoration: none;">CAEI Elite Training</a>. Tous droits réservés. | <a href="{{ route('home') }}" style="color: rgba(255,255,255,0.4); text-decoration: none;">← Retour au portail CAEI</a>
      </p>
    </div>
  </footer>
