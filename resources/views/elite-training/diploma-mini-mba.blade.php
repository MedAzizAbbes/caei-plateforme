          ...
          <form action="{{ route('elite.appointment.store') }}" method="POST" id="contactForm">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="nom" class="form-control pro-input" placeholder="Ex: Mohamed Ben Ali" required>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label class="form-label font-bold text-slate-700 small">Numéro de Téléphone</label>
                <input type="text" name="mobile" class="form-control pro-input" placeholder="+216 XX XXX XXX">
              </div>
              <div class="col-md-6">
                <label class="form-label font-bold text-slate-700 small">Spécialité sélectionnée</label>
                <input type="text" id="objetInput" name="objet" class="form-control pro-input bg-white font-bold text-[#061743]" value="Inscription Mini MBA" placeholder="Ex: Mini MBA - Marketing Digital" readonly>
              </div>
              <div class="col-12">
                <label class="form-label font-bold text-slate-700 small">Message / Motivations <span class="text-danger">*</span></label>
                <textarea name="message" class="form-control pro-input" rows="4" placeholder="Présentez brièvement vos objectifs de formation..." required></textarea>
              </div>
