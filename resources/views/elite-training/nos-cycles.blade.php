          ...
          <form action="{{ route('elite.appointment.store') }}" method="POST" id="modalForm">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="nom" class="form-control form-control-lg rounded-3 border-light-subtle shadow-sm" placeholder="Ex: Jean Dupont" required>
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold text-dark fs-6">Adresse Email <span class="text-danger">*</span></label>
                <input type="email" name="email" class="form-control form-control-lg rounded-3 border-light-subtle shadow-sm" placeholder="Ex: jean.dupont@email.com" required>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold text-dark fs-6">Cycle sélectionné</label>
                <input type="text" name="objet" id="modalObjetInput" class="form-control form-control-lg rounded-3 border-light-subtle shadow-sm bg-light" readonly>
              </div>
              <div class="col-12">
                <label class="form-label fw-semibold text-dark fs-6">Message / Note supplémentaire</label>
                <textarea name="message" class="form-control rounded-3 border-light-subtle shadow-sm" rows="3" placeholder="Précisez votre organisme, entreprise ou toute question particulière..."></textarea>
              </div>
