  ...
  <nav class="navbar navbar-expand-lg sticky-top et-navbar">
    <div class="container">
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <a href="{{ route('elite.inscription', ['formation_title' => 'Executive MBA']) }}" class="btn-gold btn-sm">S'inscrire</a>
      </div>
    </div>
  </nav>
          ...
          <form action="{{ route('elite.appointment.store') }}" method="POST" id="contactForm">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="objetInput" name="objet" class="form-control pro-input" value="Inscription Executive MBA" placeholder="Intitulé de la formation" required>
              </div>
