...
(function() {
  ...
  function animateWelcomeText() {
    ...
    const text2 = "CAEI COMPANY GROUP";
    ...
    animateText(text1, element1, 0.5);
    
    // Animate second line after first line completes
    const delay1 = 0.5 + (text1.length * 0.05);
    animateText(text2, element2, delay1 + 0.2);
  }
