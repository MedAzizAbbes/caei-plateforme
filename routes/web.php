...
Route::get('/actualites/{slug}', [SeminarPublicController::class, 'actualiteShow'])->name('actualites.show');
...
Route::post('/elite-training/appointment', [\App\Http\Controllers\EliteAppointmentController::class, 'store'])
    ->middleware('throttle:6,1')
    ->name('elite.appointment.store');
...
Route::post('/medical-services/devis', [\App\Http\Controllers\MedicalServiceController::class, 'storeRequest'])
    ->middleware('throttle:6,1')
    ->name('medical.services.request');
